 ...
 * $Revision: 3 $
 * $Date: 15/12/14 3:53p $
 * @brief    NANO103 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
/** @addtogroup NANO103_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
...
#define SCUART_TIMEOUT_ERR    (-1L) 

/*@}*/ /* end of group NANO103_SCUART_EXPORTED_CONSTANTS */
