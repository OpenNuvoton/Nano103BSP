 ...
 * $Revision: 4 $
 * $Date: 15/12/07 5:41p $
 * @brief    NANO103 series WDT driver header file
 *
 * @note
...
/** @addtogroup NANO103_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO103_WDT_EXPORTED_CONSTANTS */
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_RESET_FLAG()  (WDT->STATUS = WDT_STATUS_RSTF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_INT_FLAG() (WDT->STATUS = WDT_STATUS_WDTIF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_WAKEUP_FLAG() (WDT->STATUS = WDT_STATUS_WKF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_RESET_FLAG() (WDT->STATUS & WDT_STATUS_RSTF_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_TIMEOUT_INT_FLAG() (WDT->STATUS & WDT_STATUS_WDTIF_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_TIMEOUT_WAKEUP_FLAG() (WDT->STATUS & WDT_STATUS_WKF_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_RESET_COUNTER() (WDT->CTL  |= WDT_CTL_RSTCNT_Msk)
