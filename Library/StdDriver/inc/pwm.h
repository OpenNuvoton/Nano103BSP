 ...
 * $Revision: 5 $
 * $Date: 16/02/17 7:35p $
 * @brief    NANO103 series PWM driver header file
 *
 * @note
...
/** @addtogroup NANO103_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup NANO103_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
/*  Waveform Generator Control Constant Definitions                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_WGCTL0_ZPCTL0_Msk                    (3UL << PWM_WGCTL0_ZPCTLn_Pos)        /*!< PWM channel 0 zero point control \hideinitializer */
#define PWM_WGCTL0_PRDPCTL0_Msk                  (3UL << PWM_WGCTL0_PRDPCTLn_Pos)      /*!< PWM channel 0 period point control \hideinitializer */
#define PWM_WGCTL1_CMPUCTL0_Msk                  (3UL << PWM_WGCTL1_CMPUCTLn_Pos)      /*!< PWM channel 0 period point control \hideinitializer */
#define PWM_WGCTL1_CMPDCTL0_Msk                  (3UL << PWM_WGCTL1_CMPDCTLn_Pos)      /*!< PWM channel 0 period point control \hideinitializer */
...
#define PWM_FB_EDGE_SYS_BOD                      (PWM_BRKCTL0_1_SYSEEN_Msk | PWM_FAILBRK_BODBRKEN_Msk)    /*!< System fail condition: brown-out detection as edge-detect fault brake source \hideinitializer */
#define PWM_FB_EDGE_SYS_COR                      (PWM_BRKCTL0_1_SYSEEN_Msk | PWM_FAILBRK_CORBRKEN_Msk)    /*!< System fail condition: core lockup detection as edge-detect fault brake source \hideinitializer */
...
#define PWM_FB_LEVEL_SYS_BOD                     (PWM_BRKCTL0_1_SYSLEN_Msk | PWM_FAILBRK_BODBRKEN_Msk)    /*!< System fail condition: brown-out detection as level-detect fault brake source \hideinitializer */
#define PWM_FB_LEVEL_SYS_COR                     (PWM_BRKCTL0_1_SYSLEN_Msk | PWM_FAILBRK_CORBRKEN_Msk)    /*!< System fail condition: core lockup detection as level-detect fault brake source \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
/*  Capture Control and Status Constant Definitions                                                        */
/*---------------------------------------------------------------------------------------------------------*/
...
#define PWM_CAPSTS_CRIFOV0_Msk            (1 << PWM_CAPSTS_CRIFOVn_Pos) /*!< PWM channel 0 capture rising interrupt flag overrun status \hideinitializer */
#define PWM_CAPSTS_CFIFOV0_Msk            (1 << PWM_CAPSTS_CFIFOVn_Pos) /*!< PWM channel 0 capture falling interrupt flag overrun status \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  Duty Interrupt Type Constant Definitions                                                               */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_DUTY_INT_DOWN_COUNT_MATCH_CMP        (1 << PWM_INTEN0_CMPDIENn_Pos)   /*!< PWM duty interrupt triggered if down count match comparator \hideinitializer */
#define PWM_DUTY_INT_UP_COUNT_MATCH_CMP          (1 << PWM_INTEN0_CMPUIENn_Pos)   /*!< PWM duty interrupt triggered if up count match comparator \hideinitializer */
...
/*@}*/ /* end of group NANO103_PWM_EXPORTED_CONSTANTS */


/** @addtogroup NANO103_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
 ...
 * \hideinitializer
 */
#define PWM_ENABLE_COMPLEMENTARY_MODE(pwm) ((pwm)->CTL1 = (pwm)->CTL1 | PWM_CTL1_PWMMODEn_Msk)
 ...
 * \hideinitializer
 */
#define PWM_DISABLE_COMPLEMENTARY_MODE(pwm) ((pwm)->CTL1 = (pwm)->CTL1 & ~PWM_CTL1_PWMMODEn_Msk)
...
/*@}*/ /* end of group NANO103_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO103_PWM_Driver */
