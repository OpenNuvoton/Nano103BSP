 ...
 * $Revision: 4 $
 * $Date: 15/12/15 9:30a $
 * @brief    NANO103 series GPIO driver header file
 *
 * @note
...
/** @addtogroup NANO103_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO103_GPIO_EXPORTED_CONSTANTS */
