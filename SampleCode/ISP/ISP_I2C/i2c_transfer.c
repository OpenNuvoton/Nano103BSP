...
{
    /* Reset I2C1 */
    SYS->IPRST2 |=  SYS_IPRST2_I2C1RST_Msk;
    SYS->IPRST2 &= ~SYS_IPRST2_I2C1RST_Msk;
    /* Open I2C1 and set clock to 100k */
    I2C1->CLKDIV = (uint32_t)((((SystemCoreClock/2) * 10U) / (100000 * 4U) + 5U) / 10U - 1U); /* Compute proper divider for I2C clock */;
...
void I2C1_IRQHandler(void)
{
    ...
    if (I2C_GET_TIMEOUT_FLAG(I2C1))
    {
        ...
        I2C1->INTSTS |= I2C_INTSTS_TOIF_Msk;
    }
    else
    {
