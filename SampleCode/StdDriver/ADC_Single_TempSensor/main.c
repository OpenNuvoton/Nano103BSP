 ...
 * $Revision: 2 $
 * $Date: 16/02/19 9:37a $
 * @brief    Convert ADC channel 14(temperature sensor) in Single mode and print conversion results.
 *
 * @note
...
int32_t main (void)
{
    ...
    /*
       ...
       Configure to ADC single-ended, single mode and enable channel 14(temperature sensor)
