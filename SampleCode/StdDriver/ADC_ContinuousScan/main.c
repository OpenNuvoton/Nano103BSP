...
void SYS_Init(void)
{
    ...
    PA->DINOFF = PA->DINOFF | (((1<<0) | (1<<1) | (1<<2)) << GPIO_DINOFF_DINOFF0_Pos);
...
int32_t main (void)
{
    ...
    printf("+------------------------------------------------------------------------+\n");
    printf("|                 ADC Continuous mode Sample Code                        |\n");
    printf("+------------------------------------------------------------------------+\n");

    /*
      This sample code demonstrate ADC continuous scan conversion.
      Configure to single-ended, continuous mode, and enable channel 0,1,2.
      Set reference voltage to AVDD and enable ADF interrupt.
      It convert channel 0,1,2 continuously and print conversion result
     */
